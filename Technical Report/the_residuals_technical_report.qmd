...
# Methodology
## Design and Setup 
In February 2025, we conducted an experiment to determine if different caffeinated and caffeine-free drinks effect the problem solving skills of virtual participants on The Islands. Our experiment utilized a balanced one-way design with blocking. Participants were blocked out into one of three age groups, where they were given one of five drinks (the treatment) and had their score on a 20 minute problem solving test (the response) recorded.

Each of the three age group blocks contained an equal number of participants for each treatment. While we did not have any major factors that we could easily control for, to help account for nuisance factors treatments were randomly assigned among participants using an R script (See [@lst-rand] in Appendix).
