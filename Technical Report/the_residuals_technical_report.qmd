...
In February 2025, we conducted an experiment to determine if different caffeinated and caffeine-free drinks effect the problem solving skills of virtual participants on The Islands. The experiment utilized a balanced design, involving participants ages 18 and up. A one-way ANOVA design was used, where our factor was the drink given to participants and the response variable was a participant's score on a twenty minute problem solving test.
