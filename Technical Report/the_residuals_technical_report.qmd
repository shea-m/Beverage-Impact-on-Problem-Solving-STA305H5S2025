...
In February 2025, we conducted an experiment to determine if different caffeinated and caffeine-free drinks effect the problem solving skills of virtual participants on The Islands. Our experiment utilized a balanced Kruskal-Wallis test. The factor was the drink given to each participant and the response variable was a participant's score on a twenty minute problem solving test.
...
The first assumption of independence is satisfied. All data points are collected from unique individuals whose results do not depend on the others. 
